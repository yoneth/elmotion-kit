...
class Plugin {
	...
	public function editor_scripts() {
		...
		// Bridge moved to print_emk_editor_scripts() — Elementor 4.1+ buffers wp_print_scripts output
	...
	public function print_emk_editor_scripts() {
		...
		$bridge = EMK_PATH . 'assets/js/emk-shader-editor-bridge.js';
		$bridge_ver = file_exists( $bridge ) ? filemtime( $bridge ) : EMK_VERSION;
		echo '<script id="emk-shader-editor-bridge-js" src="' . esc_url( $base . 'emk-shader-editor-bridge.js' ) . '?ver=' . esc_attr( $bridge_ver ) . '"></script>' . "\n";
